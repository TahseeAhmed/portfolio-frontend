  ...
  return (
    <div className="min-h-screen pt-24 pb-20 px-6">
      <div className="max-w-5xl mx-auto">
        <div className="mb-16">
          <p className="font-mono text-gold text-xs tracking-widest uppercase mb-3">
            About Me
          </p>
          <h1 className="font-display font-extrabold text-5xl text-text leading-tight">
            The person behind
            <br />
            the <span className="gradient-gold">code</span>
          </h1>
        </div>
          ...
          <div className="md:col-span-2 space-y-5">
            ...
            <div className="grid grid-cols-2 gap-2">
              {[
                ...
                {
                  icon: <GraduationCap size={14} className="text-teal" />,
                  label: "Institute",
                  value: "Sukkur IBA",
                },
                {
                  icon: <Code2 size={14} className="text-gold-light" />,
                  label: "Focus",
                  value: "Full Stack",
                },
                {
                ...
                <div
                  key={i}
                  className="bg-surface border border-slate/40 rounded-xl p-3.5"
                >
                  ...
                  <p className="text-text text-sm font-display font-semibold">
                    {item.value}
                  </p>
                </div>
              ))}
          ...
          <div className="md:col-span-3 space-y-10">
            <div>
              ...
              <div className="space-y-4 text-muted font-body leading-relaxed text-[15px]">
                <p>
                  I'm{" "}
                  <span className="text-text font-semibold">Tahseen Ahmed</span>
                  , a Full Stack Developer and Computer Science student at{" "}
                  <span className="text-teal font-medium">
                    Sukkur IBA University
                  </span>{" "}
                  — one of the top institutions in Sindh, Pakistan.
                </p>
                <p>
                  I specialize in the{" "}
                  <span className="text-gold font-medium">MERN stack</span>{" "}
                  (MongoDB, Express.js, React, Node.js) and love architecting
                  clean, scalable systems that solve real-world problems.
                </p>
                <p>
                  Beyond code, I'm passionate about open source, teaching
                  others, and pushing the boundaries of what's possible with
            ...
            <div>
              ...
              <div className="space-y-3">
                {[
                  ...
                  <div
                    key={i}
                    className="flex items-start gap-3 text-muted text-sm font-body bg-surface border border-slate/30 rounded-xl px-4 py-3"
                  >
                    <span className="text-gold font-mono font-bold text-xs mt-0.5">
            ...
            <div>
              ...
              <div className="grid grid-cols-3 gap-3">
                {[
                  ...
                  <div
                    key={i}
                    className="bg-surface border border-slate/40 rounded-xl p-3 text-center card-hover"
                  >
